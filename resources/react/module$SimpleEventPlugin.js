...
var SimpleEventPlugin$$module$SimpleEventPlugin = {eventTypes:eventTypes$$module$SimpleEventPlugin, executeDispatch:function(event, listener, domID) {
  ...
  switch(topLevelType) {
    ...
    ;
    case topLevelTypes$$module$SimpleEventPlugin.topContextMenu:
    ;
