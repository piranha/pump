...
dragOver:{phasedRegistrationNames:{bubbled:keyOf$$module$SimpleEventPlugin({onDragOver:true}), captured:keyOf$$module$SimpleEventPlugin({onDragOverCapture:true})}}, dragStart:{phasedRegistrationNames:{bubbled:keyOf$$module$SimpleEventPlugin({onDragStart:true}), captured:keyOf$$module$SimpleEventPlugin({onDragStartCapture:true})}}, drop:{phasedRegistrationNames:{bubbled:keyOf$$module$SimpleEventPlugin({onDrop:true}), captured:keyOf$$module$SimpleEventPlugin({onDropCapture:true})}}, focus:{phasedRegistrationNames:{bubbled:keyOf$$module$SimpleEventPlugin({onFocus:true}), 
captured:keyOf$$module$SimpleEventPlugin({onFocusCapture:true})}}, input:{phasedRegistrationNames:{bubbled:keyOf$$module$SimpleEventPlugin({onInput:true}), captured:keyOf$$module$SimpleEventPlugin({onInputCapture:true})}}, keyDown:{phasedRegistrationNames:{bubbled:keyOf$$module$SimpleEventPlugin({onKeyDown:true}), captured:keyOf$$module$SimpleEventPlugin({onKeyDownCapture:true})}}, keyPress:{phasedRegistrationNames:{bubbled:keyOf$$module$SimpleEventPlugin({onKeyPress:true}), captured:keyOf$$module$SimpleEventPlugin({onKeyPressCapture:true})}}, 
keyUp:{phasedRegistrationNames:{bubbled:keyOf$$module$SimpleEventPlugin({onKeyUp:true}), captured:keyOf$$module$SimpleEventPlugin({onKeyUpCapture:true})}}, mouseDown:{phasedRegistrationNames:{bubbled:keyOf$$module$SimpleEventPlugin({onMouseDown:true}), captured:keyOf$$module$SimpleEventPlugin({onMouseDownCapture:true})}}, mouseMove:{phasedRegistrationNames:{bubbled:keyOf$$module$SimpleEventPlugin({onMouseMove:true}), captured:keyOf$$module$SimpleEventPlugin({onMouseMoveCapture:true})}}, mouseUp:{phasedRegistrationNames:{bubbled:keyOf$$module$SimpleEventPlugin({onMouseUp:true}), 
captured:keyOf$$module$SimpleEventPlugin({onMouseUpCapture:true})}}, paste:{phasedRegistrationNames:{bubbled:keyOf$$module$SimpleEventPlugin({onPaste:true}), captured:keyOf$$module$SimpleEventPlugin({onPasteCapture:true})}}, scroll:{phasedRegistrationNames:{bubbled:keyOf$$module$SimpleEventPlugin({onScroll:true}), captured:keyOf$$module$SimpleEventPlugin({onScrollCapture:true})}}, submit:{phasedRegistrationNames:{bubbled:keyOf$$module$SimpleEventPlugin({onSubmit:true}), captured:keyOf$$module$SimpleEventPlugin({onSubmitCapture:true})}}, 
touchCancel:{phasedRegistrationNames:{bubbled:keyOf$$module$SimpleEventPlugin({onTouchCancel:true}), captured:keyOf$$module$SimpleEventPlugin({onTouchCancelCapture:true})}}, touchEnd:{phasedRegistrationNames:{bubbled:keyOf$$module$SimpleEventPlugin({onTouchEnd:true}), captured:keyOf$$module$SimpleEventPlugin({onTouchEndCapture:true})}}, touchMove:{phasedRegistrationNames:{bubbled:keyOf$$module$SimpleEventPlugin({onTouchMove:true}), captured:keyOf$$module$SimpleEventPlugin({onTouchMoveCapture:true})}}, 
touchStart:{phasedRegistrationNames:{bubbled:keyOf$$module$SimpleEventPlugin({onTouchStart:true}), captured:keyOf$$module$SimpleEventPlugin({onTouchStartCapture:true})}}, wheel:{phasedRegistrationNames:{bubbled:keyOf$$module$SimpleEventPlugin({onWheel:true}), captured:keyOf$$module$SimpleEventPlugin({onWheelCapture:true})}}};
var topLevelEventsToDispatchConfig$$module$SimpleEventPlugin = {topBlur:eventTypes$$module$SimpleEventPlugin.blur, topClick:eventTypes$$module$SimpleEventPlugin.click, topCopy:eventTypes$$module$SimpleEventPlugin.copy, topCut:eventTypes$$module$SimpleEventPlugin.cut, topDoubleClick:eventTypes$$module$SimpleEventPlugin.doubleClick, topDrag:eventTypes$$module$SimpleEventPlugin.drag, topDragEnd:eventTypes$$module$SimpleEventPlugin.dragEnd, topDragEnter:eventTypes$$module$SimpleEventPlugin.dragEnter, 
topDragExit:eventTypes$$module$SimpleEventPlugin.dragExit, topDragLeave:eventTypes$$module$SimpleEventPlugin.dragLeave, topDragOver:eventTypes$$module$SimpleEventPlugin.dragOver, topDragStart:eventTypes$$module$SimpleEventPlugin.dragStart, topDrop:eventTypes$$module$SimpleEventPlugin.drop, topFocus:eventTypes$$module$SimpleEventPlugin.focus, topInput:eventTypes$$module$SimpleEventPlugin.input, topKeyDown:eventTypes$$module$SimpleEventPlugin.keyDown, topKeyPress:eventTypes$$module$SimpleEventPlugin.keyPress, 
topKeyUp:eventTypes$$module$SimpleEventPlugin.keyUp, topMouseDown:eventTypes$$module$SimpleEventPlugin.mouseDown, topMouseMove:eventTypes$$module$SimpleEventPlugin.mouseMove, topMouseUp:eventTypes$$module$SimpleEventPlugin.mouseUp, topPaste:eventTypes$$module$SimpleEventPlugin.paste, topScroll:eventTypes$$module$SimpleEventPlugin.scroll, topSubmit:eventTypes$$module$SimpleEventPlugin.submit, topTouchCancel:eventTypes$$module$SimpleEventPlugin.touchCancel, topTouchEnd:eventTypes$$module$SimpleEventPlugin.touchEnd, 
topTouchMove:eventTypes$$module$SimpleEventPlugin.touchMove, topTouchStart:eventTypes$$module$SimpleEventPlugin.touchStart, topWheel:eventTypes$$module$SimpleEventPlugin.wheel};
